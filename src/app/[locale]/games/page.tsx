...
export default function GamesPage() {
  ...
  const t = useTranslations("games_page");
            ...
            <div style={{ padding: "32px" }}>
              ...
              <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6" style={{ marginBottom: "32px" }}>
                <div>
                  <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "12px" }}>
                    ...
                    <span style={{ display: "flex", alignItems: "center", gap: "6px" }}>
                      ...
                      <span className="font-heading font-bold uppercase" style={{ fontSize: "10px", color: "#555555", letterSpacing: "0.15em" }}>{game.status === "Active" ? t("active") : t("building")}</span>
                    </span>
                  </div>
                ...
                <div style={{ display: "flex", gap: "32px", flexShrink: 0 }}>
                  {[{ label: t("format"), value: game.format }, { label: t("region"), value: game.region }, { label: t("teams"), value: game.teams > 0 ? String(game.teams) : "—" }].map((s) => (
                    <div key={s.label}>
              ...
              <div className="grid md:grid-cols-2 gap-8" style={{ paddingTop: "24px", borderTop: "1px solid #2A2A2A" }}>
                {/* Roles */}
                <div>
                  <p className="font-heading font-bold uppercase" style={{ fontSize: "10px", letterSpacing: "0.18em", color: "#555555", marginBottom: "16px" }}>{t("roles")}</p>
                ...
                {/* Highlights */}
                <div>
                  <p className="font-heading font-bold uppercase" style={{ fontSize: "10px", letterSpacing: "0.18em", color: "#555555", marginBottom: "16px" }}>{t("highlights")}</p>
